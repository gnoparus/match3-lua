...
function love.draw()
    push:start()
    love.graphics.printf('Timer: ' .. tostring(currentSecond) .. ' seconds', 0, 68, VIRTUAL_WIDTH, 'center')
    love.graphics.printf('Timer: ' .. tostring(currentSecond2) .. ' seconds', 0, 82, VIRTUAL_WIDTH, 'center')
    love.graphics.printf('Timer: ' .. tostring(currentSecond3) .. ' seconds', 0, 96, VIRTUAL_WIDTH, 'center')
    love.graphics.printf('Timer: ' .. tostring(currentSecond4) .. ' seconds', 0, 110, VIRTUAL_WIDTH, 'center')
    love.graphics.printf('Timer: ' .. tostring(currentSecond5) .. ' seconds', 0, 124, VIRTUAL_WIDTH, 'center')
    push:finish()
end
